...
local newPlayer = anim8.newPlayer
...
describe("anim8", function()
  describe("newPlayer", function()
    it("sets basic properties", function()
      ...
      local a = newPlayer(animation, 1/4, loop)
    ...
    describe(":update", function()
      ...
      describe("When the animation loops", function()
        it("invokes the onloop callback", function()
          ...
          local a = newPlayer(animation, 1, function() looped = true end)
          assert.False(looped)
          a:update(4)
          assert.True(looped)
        end)
        ...
        it("accepts the callback as a string", function()
          ...
          local a = newPlayer(animation, 1, 'foo')
        ...
        it("counts the loops", function()
          ...
          local a = newPlayer(animation, 1, function(a, x) count = count + x end)
          a:update(4)
